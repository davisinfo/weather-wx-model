		...
		City.all.each do |city|
			...
			dbdata.each do |_data|
				...
				if _data.is_forecast then
					...
					total_wdata[_data.week][_data.date][:forecasts][_idx][:tdd] += _data.tdd
					total_wdata[_data.week][_data.date][:forecasts][_idx][:cdd] += _data.cdd
					total_wdata[_data.week][_data.date][:forecasts][_idx][:hdd] += _data.hdd
					total_wdata[_data.week][_data.date][:forecasts][_idx][:count] += 1
					total_wdata[_data.week][_data.date][:forecasts][_idx][:total_tdd] += _data.tdd
					total_wdata[_data.week][_data.date][:forecasts][_idx][:total_cdd] += _data.cdd
					total_wdata[_data.week][_data.date][:forecasts][_idx][:total_hdd] += _data.hdd
				else
					...
					total_wdata[_data.week][_data.date][:real][:tdd] += _data.tdd
					total_wdata[_data.week][_data.date][:real][:cdd] += _data.cdd
					total_wdata[_data.week][_data.date][:real][:hdd] += _data.hdd

					total_wdata[_data.week][_data.date][:real][:count] += 1
					total_wdata[_data.week][_data.date][:real][:total_tdd] += _data.tdd
					total_wdata[_data.week][_data.date][:real][:total_cdd] += _data.cdd
					total_wdata[_data.week][_data.date][:real][:total_hdd] += _data.hdd
				end
